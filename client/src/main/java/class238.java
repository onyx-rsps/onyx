...
public class class238 extends class354 {
   ...
   class238(byte[] var1) {
      this.field2870 = new class23[128];
      this.field2869 = new short[128];
      this.field2874 = new byte[128];
      this.field2868 = new byte[128];
      ...
      this.field2871 = var2.method5948() + 1;
      ...
      for(var27 = 0; var27 < var12; ++var27) {
         ...
         if (null != var28.field2809) {
            for(var29 = 1; var29 < var28.field2809.length; var29 += 2) {
               var28.field2809[var29] = var2.method5949();
            }
         }

         if (null != var28.field2812) {
            for(var29 = 3; var29 < var28.field2812.length - 2; var29 += 2) {
               var28.field2812[var29] = var2.method5949();
            }
         }
      }
      ...
      if (null != var39) {
         for(var27 = 1; var27 < var39.length; var27 += 2) {
            var39[var27] = var2.method5949();
         }
      }

      if (null != var40) {
         for(var27 = 1; var27 < var40.length; var27 += 2) {
            var40[var27] = var2.method5949();
         }
      }
      ...
      for(var27 = 0; var27 < var12; ++var27) {
         var37[var27].field2807 = var2.method5948();
      }

      for(var27 = 0; var27 < var12; ++var27) {
         var28 = var37[var27];
         if (var28.field2809 != null) {
            var28.field2808 = var2.method5948();
         }

         if (var28.field2812 != null) {
            var28.field2806 = var2.method5948();
         }

         if (var28.field2807 > 0) {
            var28.field2810 = var2.method5948();
         }
      }

      for(var27 = 0; var27 < var12; ++var27) {
         var37[var27].field2811 = var2.method5948();
      }

      for(var27 = 0; var27 < var12; ++var27) {
         var28 = var37[var27];
         if (var28.field2811 > 0) {
            var28.field2805 = var2.method5948();
         }
      }
      ...
      for(var27 = 0; var27 < var12; ++var27) {
         ...
         if (var28.field2805 > 0) {
            var28.field2813 = var2.method5948();
         }
      }
   ...
   static void method4112(class277 var0, class277 var1, boolean var2, int var3) {
      if (class56.field798) {
         ...
         if (!class38.field308.field1114) {
            class150.method2513(2, class109.field1326, "scape main", "", 255, false);
         } else {
         ...
         class56.field825 = (class69.field971 - 765) / 2;
