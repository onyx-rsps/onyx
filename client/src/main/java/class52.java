...
public final class class52 extends class201 {
   ...
   static void method1533(class302 var0, class302 var1) {
      if (class189.field2127 == null) {
         class189.field2127 = class61.method1618(class271.field3536, "sl_back", "");
      }
      ...
      int var6;
      if (field770 == null) {
         var4 = class271.field3536;
         var5 = var4.method4428("sl_flags");
         var6 = var4.method4430(var5, "");
         var3 = class133.method2305(var4, var5, var6);
         field770 = var3;
      }

      if (class46.field392 == null) {
         var4 = class271.field3536;
         var5 = var4.method4428("sl_arrows");
         var6 = var4.method4430(var5, "");
         var3 = class133.method2305(var4, var5, var6);
         class46.field392 = var3;
      }

      if (class61.field897 == null) {
         var4 = class271.field3536;
         var5 = var4.method4428("sl_stars");
         var6 = var4.method4430(var5, "");
         var3 = class133.method2305(var4, var5, var6);
      ...
      if (class138.field1520 == null) {
         class138.field1520 = class118.method2187(class271.field3536, "leftarrow", "");
      }

      if (class96.field1257 == null) {
         class96.field1257 = class118.method2187(class271.field3536, "rightarrow", "");
      }
      ...
      if (class46.field392 != null) {
         ...
         if (0 == class48.field696[0] && class48.field695[0] == 0) {
            class46.field392[2].method6349(var23, 4);
         } else {
            class46.field392[0].method6349(var23, 4);
         }

         if (0 == class48.field696[0] && 1 == class48.field695[0]) {
            class46.field392[3].method6349(var23 + 15, 4);
         } else {
            class46.field392[1].method6349(15 + var23, 4);
         }
         ...
         if (class48.field696[0] == 1 && class48.field695[0] == 0) {
            class46.field392[2].method6349(var25, 4);
         } else {
            class46.field392[0].method6349(var25, 4);
         }

         if (1 == class48.field696[0] && 1 == class48.field695[0]) {
            class46.field392[3].method6349(15 + var25, 4);
         } else {
            class46.field392[1].method6349(var25 + 15, 4);
         }
         ...
         if (2 == class48.field696[0] && class48.field695[0] == 0) {
            class46.field392[2].method6349(var5, 4);
         } else {
            class46.field392[0].method6349(var5, 4);
         }

         if (2 == class48.field696[0] && class48.field695[0] == 1) {
            class46.field392[3].method6349(var5 + 15, 4);
         } else {
            class46.field392[1].method6349(var5 + 15, 4);
         }
         ...
         if (class48.field696[0] == 3 && class48.field695[0] == 0) {
            class46.field392[2].method6349(var6, 4);
         } else {
            class46.field392[0].method6349(var6, 4);
         }

         if (class48.field696[0] == 3 && class48.field695[0] == 1) {
            class46.field392[3].method6349(var6 + 15, 4);
         } else {
            class46.field392[1].method6349(15 + var6, 4);
         }
      ...
      if (null != class189.field2127) {
         ...
         if (null != class138.field1520 && class56.field827 > 0) {
            class138.field1520.method6349(8, client.field687 / 2 - class138.field1520.field4264 / 2);
         }

         if (null != class96.field1257 && class56.field827 < class56.field828) {
            class96.field1257.method6349(class69.field971 - class96.field1257.field4263 - 8, client.field687 / 2 - class96.field1257.field4264 / 2);
         }
         ...
         for(var17 = var6 * var16; var17 < class48.field692 && var16 - class56.field827 < var5; ++var17) {
            ...
            if (class20.field142 >= var13 && class20.field145 >= var12 && class20.field142 < var13 + var24 && class20.field145 < var26 + var12 && var19) {
         ...
         if (var15) {
            ...
            int var28 = class20.field145 + 25;
            if (var27 + var28 > 480) {
               var28 = class20.field145 - 25 - var27;
            }

            class394.method6265(class20.field142 - var17 / 2, var28, var17, var27, 16777120);
            class394.method6292(class20.field142 - var17 / 2, var28, var17, var27, 0);
            var1.method4922(class16.field86[class56.field826].field690, class20.field142, 4 + var28 + var1.field3738, 0, -1);
         }
      }
