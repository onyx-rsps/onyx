...
public class class99 implements class98 {
         ...
         if (var0 == 3801) {
            ...
            if (3814 == var0) {
               ...
               if (3822 == var0) {
                  ...
                  var4 = class51.field747[--class51.field746];
                  class51.field738[++class2.field4 - 1] = ((class106)class104.field1294.field1436.get(var4)).field1303.method6521();
                  return 1;
               } else if (3857 == var0) {
                  var4 = class51.field747[--class51.field746];
   ...
   static final void method2072(int var0, int var1, boolean var2) {
      if (!var2 || var0 != class20.field137 || class8.field27 != var1) {
         class20.field137 = var0;
         class8.field27 = var1;
         class17.method128(25);
         class12.method98(class270.field3237, true);
         int var4 = class281.field3625;
         int var5 = class78.field1134;
         class281.field3625 = (var0 - 6) * 8;
         class78.field1134 = 8 * (var1 - 6);
         int var6 = class281.field3625 - var4;
         int var7 = class78.field1134 - var5;
         var4 = class281.field3625;
         var5 = class78.field1134;
         ...
         for(var8 = 0; var8 < 32768; ++var8) {
            ...
            if (null != var9) {
               for(var10 = 0; var10 < 10; ++var10) {
                  ...
                  var10000[var10] -= var6;
                  var10000 = var9.field1077;
                  var10000[var10] -= var7;
               }

               var9.field1069 -= 128 * var6;
               var9.field1059 -= 128 * var7;
            }
         }

         for(var8 = 0; var8 < 2048; ++var8) {
            class70 var20 = client.field524[var8];
            if (var20 != null) {
               for(var10 = 0; var10 < 10; ++var10) {
                  var10000 = var20.field1076;
                  var10000[var10] -= var6;
                  var10000 = var20.field1077;
                  var10000[var10] -= var7;
               }

               var20.field1069 -= var6 * 128;
               var20.field1059 -= 128 * var7;
            }
         }
   ...
   static final void method2073(int var0) {
      ...
      class38.field308.field1121 = var0;
      class135.method2320();
   }
}
