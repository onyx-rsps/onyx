public class class100 implements class290 {
   public static final class100 field1268;
   public static final class100 field1269;
   public static final class100 field1271;
   ...
   static {
      ...
      field1269 = new class100(0, 1);
      field1268 = new class100(2, 2);
      field1271 = new class100(1, 3);
   }
   ...
   public static class146 method2074(int var0) {
      ...
      if (null != var2) {
         ...
         var2 = new class146();
         if (null != var3) {
            var2.method2454(new class385(var3));
         }
