public class class141 extends class349 {
   ...
   class141(int var1) {
      ...
      this.field1533 = new String[5];
      this.field1545 = Integer.MAX_VALUE;
      this.field1546 = Integer.MAX_VALUE;
      this.field1547 = Integer.MIN_VALUE;
      this.field1538 = Integer.MIN_VALUE;
   ...
   void method2364(class385 var1, int var2) {
      if (1 == var2) {
         this.field1535 = var1.method5965();
      } else if (2 == var2) {
         this.field1536 = var1.method5965();
      } else if (var2 == 3) {
         this.field1537 = var1.method5957();
      } else if (4 == var2) {
         this.field1548 = var1.method5952();
      } else if (5 == var2) {
         var1.method5952();
      } else if (6 == var2) {
         this.field1539 = var1.method5948();
      } else {
         int var4;
         if (var2 == 7) {
            ...
            this.field1533[var2 - 10] = var1.method5957();
         } else if (var2 == 15) {
            var4 = var1.method5948();
            ...
            for(var6 = 0; var6 < var4; ++var6) {
               this.field1552[var6] = var1.method5949();
            }
         } else if (16 != var2) {
            if (var2 == 17) {
               this.field1543 = var1.method5957();
            } else if (18 == var2) {
               var1.method5965();
            } else if (19 == var2) {
               ...
               this.field1540 = (class147)class251.method4287(var7, var1.method5948());
            } else if (var2 == 30) {
               this.field1550 = (class149)class251.method4287(class5.method17(), var1.method5948());
            }
         }
      }
