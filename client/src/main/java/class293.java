   ...
   static int method4650(int var0, class59 var1, boolean var2) {
      ...
      if (var0 == 1000) {
         ...
         if (-1 != var4 && 0 == var5.field2977) {
            class81.method1868(class249.field3039[var4 >> 16], var5, false);
         }
   ...
   static void method4647() {
      ...
      if (class56.field809.length() == 0) {
         ...
         if (var2 == 0L) {
            ...
            var1 = client.method1270(var2, class56.field809);
         }
      ...
      if (class56.field800) {
         ...
         if (client.loginType == 20) {
            ...
            if (class56.field812 != 4) {
               ...
               var0.method4853(class303.method4915(var6), class56.field817 + 180 - 70, var13, 16777215, 0);
               var13 += 15;
         ...
         if (client.loginType == 10 || client.loginType == 11) {
            ...
            if (class56.field812 == 0) {
               ...
               if (class56.field812 == 2) {
                  ...
                  var0.method4853(class303.method4915(var6) + (0 == class56.field822 & client.field452 % 40 < 20 ? class44.method770(16776960) + class79.field1138 : ""), class167.field1932 - 70, var13, 16777215, 0);
                  var13 += 15;
                  ...
                  class397 var9 = method4652(client.field443, class56.field830);
                  ...
                  var9 = method4652(class38.field308.field1117, class56.field820);
                  var9.method6349(var8, var12);
                  ...
                  if (4 == class56.field812) {
                     ...
                     var0.method4853(class303.method4915(var6) + (client.field452 % 40 < 20 ? class44.method770(16776960) + class79.field1138 : ""), 180 + class56.field817 - 34, var13, 16777215, 0);
                     var13 += 15;
         ...
         if (client.loginType > 5 && class284.field3644 == class292.field3694) {
            if (class236.field2847 != null) {
               ...
               class236.field2847 = class118.method2187(class271.field3536, "sl_button", "");
            }
         }
