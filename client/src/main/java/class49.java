public class class49 {
   ...
   final void method1322() {
      for(class322 var2 = (class322)this.field712.field3830.method4797(); var2 != null; var2 = (class322)this.field712.field3830.method4798()) {
         if ((long)var2.field3847 < class87.method1989() / 1000L - 5L) {
            ...
            if (var2.field3846 == 0) {
               class121.method2204(5, "", var2.field3844 + class270.field3378);
            }
   ...
   final boolean method1324(class406 var1, boolean var2) {
      if (null == var1) {
         return false;
      } else if (var1.equals(class20.field140.field980)) {
         return true;
      } else {
   ...
   final void method1326(String var1) {
      if (null != var1) {
         ...
         if (var3.method6523()) {
            if (this.method1337()) {
               class159.method2805();
            } else if (class20.field140.field980.equals(var3)) {
               class20.method326(class270.field3400);
            } else if (this.method1324(var3, false)) {
               class20.method326(var1 + class270.field3397);
   ...
   final boolean method1337() {
      return this.field712.method5253() || this.field712.method5200() >= 200 && 1 != client.field526;
   }
      ...
      if (null != var1) {
         ...
         if (var3.method6523()) {
            if (this.method1328()) {
               ...
               class20.method326(var1 + class270.field3399);
            } else if (this.method1324(var3, false)) {
               class20.method326(class270.field3404 + var1 + class270.field3509);
            } else {
   ...
   final boolean method1328() {
      return this.field713.method5253() || this.field713.method5200() >= 100 && 1 != client.field526;
   }
   ...
   static final void method1382(int var0, int var1) {
      class296 var3 = client.field536[class285.field3652][var0][var1];
      if (var3 == null) {
         class166.field1925.method3518(class285.field3652, var0, var1);
      } else {
         long var4 = -99999999L;
         class82 var6 = null;
         ...
         for(var7 = (class82)var3.method4687(); var7 != null; var7 = (class82)var3.method4678()) {
            class157 var8 = class11.method93(var7.field1167);
         ...
         if (null == var6) {
            ...
            class166.field1925.method3504(class285.field3652, var0, var1, class123.method2216(64 + 128 * var0, 64 + var1 * 128, class285.field3652), var6, var10, var12, var13);
         }
      }
   }
}
