public class class354 implements class356 {
   int field3970;
   int field3971;
   int field3972;
   ...
   void method6026(String var1) {
      String[] var3 = var1.split("\\.");

      try {
         this.field3970 = Integer.parseInt(var3[0]);
         this.field3971 = Integer.parseInt(var3[1]);
         this.field3972 = Integer.parseInt(var3[2]);
      } catch (Exception var5) {
      }

   }

   void method6027(String var1) {
      if (var1.startsWith("1.")) {
         this.method6025(var1);
      } else {
         this.method6026(var1);
      }

   }

   public class355 vmethod6044() {
      byte var2;
      if (class190.field2131.startsWith("win")) {
         var2 = 1;
      } else if (class190.field2131.startsWith("mac")) {
         var2 = 2;
      } else if (class190.field2131.startsWith("linux")) {
         var2 = 3;
      } else {
         var2 = 4;
      }
      ...
      String var19 = "";
      int[] var24 = new int[3];
      return new class355(var2, var25, var8, var9, this.field3970, this.field3971, this.field3972, false, var11, var12, var13, 0, var14, var15, var16, var17, 0, 0, 0, 0, var18, var19, var24, 0, "");
   }
}
