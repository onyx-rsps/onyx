public class class146 extends class349 {
   ...
   void method2461(class385 var1, int var2) {
      if (1 == var2) {
         this.field1596 = (char)var1.method5948();
      } else if (var2 == 2) {
         this.field1599 = (char)var1.method5948();
      } else if (3 == var2) {
