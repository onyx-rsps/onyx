...
public class class2 implements Callable {
   ...
   static final void method6(class70 var0, int var1, int var2, int var3) {
      if (class20.field140 != var0) {
         if (client.field545 < 400) {
            String var5;
            int var8;
            if (var0.field1007 == 0) {
               String var6 = var0.field982[0] + var0.field980 + var0.field982[1];
               var8 = var0.field991;
               int var9 = class20.field140.field991;
               int var10 = var9 - var8;
               String var7;
               if (var10 < -9) {
               ...
               var5 = var6 + var7 + " " + class79.field1141 + class270.field3386 + var0.field991 + class79.field1139 + var0.field982[2];
            } else {
               var5 = var0.field982[0] + var0.field980 + var0.field982[1] + " " + class79.field1141 + class270.field3387 + var0.field1007 + class79.field1139 + var0.field982[2];
            }
               ...
               for(var11 = 7; var11 >= 0; --var11) {
                  if (null != client.field532[var11]) {
                     ...
                     if (client.field532[var11].equalsIgnoreCase(class270.field3382)) {
                        ...
                        if (class81.field1156 == client.field459 || class81.field1154 == client.field459 && var0.field991 > class20.field140.field991) {
                           var13 = 2000;
                        }

                        if (0 != class20.field140.field997 && 0 != var0.field997) {
                           if (class20.field140.field997 == var0.field997) {
                              var13 = 2000;
                           } else {
                              var13 = 0;
                           }
