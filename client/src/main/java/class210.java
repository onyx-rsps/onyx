public final class class210 {
   ...
   static int method3832(int var0, class59 var1, boolean var2) {
      ...
      if (4200 == var0) {
         ...
         class51.field738[++class2.field4 - 1] = class11.method93(var4).field1836;
         return 1;
      } else {
         int var5;
         class157 var6;
         if (var0 == 4201) {
            ...
            var4 = class51.field747[--class51.field746];
            class51.field747[++class51.field746 - 1] = class11.method93(var4).field1807;
            return 1;
         } else if (var0 == 4204) {
            var4 = class51.field747[--class51.field746];
            class51.field747[++class51.field746 - 1] = class11.method93(var4).field1806 == 1 ? 1 : 0;
            return 1;
         } else {
            class157 var8;
            if (4205 == var0) {
               var4 = class51.field747[--class51.field746];
               var8 = class11.method93(var4);
               ...
               var4 = class51.field747[--class51.field746];
               class51.field747[++class51.field746 - 1] = class11.method93(var4).field1808 ? 1 : 0;
               return 1;
            } else if (4208 == var0) {
               var4 = class51.field747[--class51.field746];
               var8 = class11.method93(var4);
               ...
               if (var0 == 4212) {
                  ...
                  var4 = class51.field747[--class51.field746];
                  var5 = class11.method93(var4).method2701();
                  if (var5 == -1) {
