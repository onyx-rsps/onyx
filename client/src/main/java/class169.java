...
public class class169 {
   public static class221 field1962;
   class163 field1965;
   int field1963;
   int field1967;
   int field1968;
   ...
   static {
      field1962 = new class221(37748736, 256);
   }
   ...
   static class59 method3070(int var0, int var1, int var2) {
      ...
      if (var5 != null) {
         ...
         if (var8 != null) {
            ...
            int var10 = class46.field391.method4428(var9);
            if (-1 == var10) {
               var7 = null;
            } else {
               byte[] var11 = class46.field391.method4419(var10);
               if (var11 != null) {
                  if (var11.length <= 1) {
                     var7 = null;
   ...
   static final void method3068(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, class160[] var8) {
      ...
      class385 var29 = new class385(var0);
