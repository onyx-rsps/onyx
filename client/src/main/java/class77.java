public class class77 extends Node {
   ...
   void method1827(int var1, int var2, int var3, int var4) {
      ...
      if (null == var6) {
         ...
         if (var7 >= 4) {
            this.field1128.method4724().method5437();
         }
   ...
   static final void method1831(class249[] var0, int var1) {
      for(int var3 = 0; var3 < var0.length; ++var3) {
         ...
         if (var4 != null) {
            if (var4.field2977 == 0) {
               ...
               if (var5 != null) {
                  class163.method2852(var5.field950, var1);
               }
            }
