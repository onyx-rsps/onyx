public class class105 extends class104 {
   ...
   static int method2095(int var0, int var1) {
      ...
      if (null == var3) {
         ...
         int var7;
         if (var3.field1856 >= 0) {
            var7 = class85.method1936(class198.field2269.method3835(var3.field1856), 96);
            return class198.field2268[var7] | -16777216;
            ...
            return class198.field2268[var6] | -16777216;
         }
      }
   }

   static void method2093(int var0) {
      class65 var2 = (class65)class65.field935.method5746((long)var0);
      if (null != var2) {
