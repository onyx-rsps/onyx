      ...
      while(true) {
         if (var1.method5901(client.field453.gpiBufLength) >= 27) {
            ...
            if (32767 != var3) {
               ...
               int var9 = var1.method5893(1);
               if (var9 == 1) {
                  client.field475[++client.field501 - 1] = var3;
               }

               int var10 = client.field534[var1.method5893(3)];
               if (var4) {
                  var5.field1043 = var5.field1022 = var10;
               }

               int var7;
               if (var0) {
                  var7 = var1.method5893(8);
                  if (var7 > 127) {
                     var7 -= 256;
                  }
               } else {
                  var7 = var1.method5893(5);
                  if (var7 > 15) {
                     var7 -= 32;
                  }
               }
               ...
               int var8;
               if (var0) {
                  var8 = var1.method5893(8);
                  if (var8 > 127) {
                     var8 -= 256;
                  }
               } else {
                  var8 = var1.method5893(5);
                  if (var8 > 15) {
                     var8 -= 32;
                  }
               }

               boolean var11 = var1.method5893(1) == 1;
               if (var11) {
                  var1.method5893(32);
               }

               var5.field1132 = class97.method2065(var1.method5893(14));
               int var6 = var1.method5893(1);
               ...
               var5.method1833(var7 + class20.field140.field1076[0], class20.field140.field1077[0] + var8, var6 == 1);
               continue;
            }
         }
