public class class377 implements class290 {
   public static final class377 field4160;
   public static final class377 field4164;
   public static final class377 field4165;
   ...
   static {
      field4164 = new class377(0, 0, Integer.class, new class374());
      field4160 = new class377(2, 1, Long.class, new class376());
      field4165 = new class377(1, 2, String.class, new class378());
   }
   ...
   static final void method5855(class249 var0, class157 var1, int var2, int var3, boolean var4) {
      ...
      if (-1 != var7 && null != var8) {
         class25.method400(var8, class44.method770(16748608) + var1.field1836, var7, var1.field1802, var2, var0.field2958, var4);
      }

   }

   static final boolean method5858(class249 var0) {
      ...
      if (var2 == 205) {
         ...
         if (326 == var2) {
            class229 var5 = class149.method2495(class227.field2658, client.field453.field1205);
            client.field598.method4181(var5.field2691);
