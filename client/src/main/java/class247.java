public class class247 {
   static class223 field2938;
   static final int[] field2933;
   boolean field2936;
   class138[] field2935;
   int[] field2929;
   int[] field2932;
   ...
   static {
      field2933 = new int[]{8, 11, 4, 6, 9, 7, 10};
      field2938 = new class223(260);
   }
      ...
      if (-1 != this.field2937) {
         ...
         if (var19 == null) {
            ...
            for(int var11 = 0; var11 < 12; ++var11) {
               ...
               if (var12 >= 512 && !class11.method93(var12 - 512).method2698(this.field2931)) {
                  var10 = true;
               }
            }
            ...
            if (var19 == null) {
               ...
               for(int var13 = 0; var13 < 12; ++var13) {
                  ...
                  if (var14 >= 512) {
                     class157 var23 = class11.method93(var14 - 512);
   ...
   class193 method4184() {
      if (this.field2937 != -1) {
         ...
         for(int var3 = 0; var3 < 12; ++var3) {
            ...
            if (var4 >= 512 && !class11.method93(var4 - 512).method2697(this.field2931)) {
               var2 = true;
            }
         }
         ...
         if (var2) {
            ...
            for(int var5 = 0; var5 < 12; ++var5) {
               ...
               if (var6 >= 512) {
                  var7 = class11.method93(var6 - 512).method2685(this.field2931);
                  if (var7 != null) {
                     var8[var4++] = var7;
                  }
               }
