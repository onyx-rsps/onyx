public class class115 {
   ...
   public static boolean method2179(int var0) {
      return var0 >= 0 && var0 < 112 ? class11.field46[var0] : false;
   }
   ...
   void method2135(Buffer var1) {
      ...
      if (var3 >= 1 && var3 <= 6) {
         ...
         this.field1360 = var1.method5949();
         this.field1369 = var1.method5949();
         this.field1370 = var1.method5949();
         this.field1384 = var1.method5949();
         int var5;
         if (this.field1372 > 0) {
            ...
            for(var5 = 0; var5 < this.field1372; ++var5) {
               ...
               if (var3 >= 6) {
                  this.field1378[var5] = var1.method5948() == 1;
               } else {
