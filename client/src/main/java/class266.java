public class class266 implements class290 {
   public static final class266 field3206;
   static class136 field3214;
   static class398[] field3211;
   static final class266 field3204;
   static final class266 field3205;
   static final class266 field3207;
   static final class266 field3212;
   static final class266 field3213;
   final int field3210;
   public final String field3208;

   static {
      field3213 = new class266("runescape", "RuneScape", 0);
      field3204 = new class266("stellardawn", "Stellar Dawn", 1);
      field3205 = new class266("game3", "Game 3", 2);
      field3212 = new class266("game4", "Game 4", 3);
      field3207 = new class266("game5", "Game 5", 4);
      field3206 = new class266("oldscape", "RuneScape 2007", 5);
   }
   ...
   static void method4348(int var0) {
      if (-3 == var0) {
