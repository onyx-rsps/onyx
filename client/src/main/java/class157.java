public class class157 extends class349 {
   public static class223 field1837;
   static class223 field1790;
   static class223 field1791;
   class363 field1831;
   int field1786;
   int field1792;
   int field1795;
   ...
   static {
      field1790 = new class223(64);
      field1791 = new class223(50);
      field1837 = new class223(200);
   }
   ...
   void method2688(class385 var1, int var2) {
      if (1 == var2) {
         ...
         this.field1836 = var1.method5957();
      } else if (var2 == 4) {
         this.field1800 = var1.method6043();
      } else if (5 == var2) {
         this.field1801 = var1.method6043();
      } else if (var2 == 6) {
         this.field1822 = var1.method6043();
      } else if (7 == var2) {
         this.field1804 = var1.method6043();
         if (this.field1804 > 32767) {
            this.field1804 -= 65536;
         }
      } else if (8 == var2) {
         this.field1805 = var1.method6043();
         ...
         this.field1807 = var1.method6172();
      } else if (16 == var2) {
         this.field1808 = true;
      } else if (23 == var2) {
         this.field1812 = var1.method6043();
         this.field1841 = var1.method5948();
      } else if (var2 == 24) {
         this.field1813 = var1.method6043();
      } else if (25 == var2) {
         this.field1815 = var1.method6043();
         this.field1817 = var1.method5948();
      } else if (var2 == 26) {
         this.field1811 = var1.method6043();
      } else if (var2 >= 30 && var2 < 35) {
         this.field1809[var2 - 30] = var1.method5957();
         if (this.field1809[var2 - 30].equalsIgnoreCase(class270.field3525)) {
            this.field1809[var2 - 30] = null;
         }
      } else if (var2 >= 35 && var2 < 40) {
         this.field1810[var2 - 35] = var1.method5957();
      } else {
         int var4;
         int var5;
         if (var2 == 40) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.field1796[var5] = (short)var1.method6043();
               this.field1797[var5] = (short)var1.method6043();
            }
         } else if (41 == var2) {
            var4 = var1.method5948();
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.field1798[var5] = (short)var1.method6043();
               this.field1799[var5] = (short)var1.method6043();
            }
         } else if (42 == var2) {
            this.field1792 = var1.method5949();
         } else if (var2 == 65) {
            this.field1834 = true;
         } else if (78 == var2) {
            this.field1818 = var1.method6043();
         } else if (var2 == 79) {
            this.field1819 = var1.method6043();
         } else if (90 == var2) {
            this.field1816 = var1.method6043();
         } else if (91 == var2) {
            this.field1835 = var1.method6043();
         } else if (92 == var2) {
            this.field1821 = var1.method6043();
         } else if (var2 == 93) {
            this.field1823 = var1.method6043();
         } else if (var2 == 94) {
            var1.method6043();
         } else if (95 == var2) {
            this.field1803 = var1.method6043();
         } else if (var2 == 97) {
            this.field1827 = var1.method6043();
         } else if (var2 == 98) {
            this.field1789 = var1.method6043();
            ...
            this.field1824[var2 - 100] = var1.method6043();
            this.field1825[var2 - 100] = var1.method6043();
         } else if (var2 == 110) {
            this.field1839 = var1.method6043();
         } else if (var2 == 111) {
            this.field1826 = var1.method6043();
         } else if (var2 == 112) {
            this.field1830 = var1.method6043();
         } else if (113 == var2) {
            this.field1793 = var1.method5949();
         } else if (114 == var2) {
            this.field1832 = var1.method5949() * 5;
         } else if (115 == var2) {
            this.field1833 = var1.method5948();
         } else if (var2 == 139) {
            this.field1829 = var1.method6043();
         } else if (var2 == 140) {
            this.field1786 = var1.method6043();
         } else if (var2 == 148) {
            this.field1838 = var1.method6043();
         } else if (149 == var2) {
            this.field1820 = var1.method6043();
         } else if (var2 == 249) {
   ...
   public final class193 method2692(int var1) {
      ...
      if (this.field1824 != null && var1 > 1) {
         ...
         if (-1 != var3) {
            return class11.method93(var3).method2692(1);
         }
      }
   ...
   public final class207 method2721(int var1) {
      if (this.field1824 != null && var1 > 1) {
         ...
         if (var3 != -1) {
            return class11.method93(var3).method2721(1);
         }
      }
   ...
   static final void method2711(class249 var0, int var1, byte[] var2, byte[] var3) {
   ...
   static void method2717(class48 var0) {
      ...
      if (var0.field700 != client.field406) {
         class275 var2 = class271.field3536;
