public class class48 {
   ...
   static void method1316(int var0, int var1, int var2, int var3) {
      for(class50 var5 = (class50)class50.field720.method4687(); var5 != null; var5 = (class50)class50.field720.method4678()) {
         if (-1 != var5.field734 || null != var5.field730) {
            ...
            if (var6 - 64 <= var5.field719 && class38.field308.field1116 != 0 && var0 == var5.field722) {
               var6 -= 64;
               if (var6 < 0) {
                  var6 = 0;
               }

               int var7 = (var5.field719 - var6) * class38.field308.field1116 / var5.field719;
               if (var5.field727 == null) {
                  if (var5.field734 >= 0) {
                     class22 var8 = class22.method357(class139.field1521, var5.field734, 0);
                     if (var8 != null) {
               ...
               if (null == var5.field725) {
                  if (var5.field730 != null && (var5.field726 -= var3) <= 0) {
                     ...
                     class22 var13 = class22.method357(class139.field1521, var5.field730[var12], 0);
                     if (null != var13) {
   ...
   static int method1293(int var0, class59 var1, boolean var2) {
      if (var0 == 5306) {
         ...
         if (var0 == 5307) {
            ...
            class51.field747[++class51.field746 - 1] = class38.field308.field1122;
            return 1;
         } else if (var0 != 5309) {
            if (var0 == 5310) {
               --class51.field746;
            ...
            var4 = class51.field747[--class51.field746];
            if (var4 == 1 || 2 == var4) {
               class38.field308.field1122 = var4;
               class135.method2320();
            }
            ...
            if (var0 == 6506) {
               ...
               if (var0 == 6512) {
                  ...
                  if (6513 == var0) {
                     ...
                     var6 = class384.method5928(var8);
                     if (var6.method2548()) {
                        class51.field738[++class2.field4 - 1] = class11.method93(var4).method2700(var8, var6.field1701);
                     } else {
                        class51.field747[++class51.field746 - 1] = class11.method93(var4).method2741(var8, var6.field1696);
                     }
   ...
   static final void method1315(class72 var0) {
      ...
      var0.field1069 += (var3 - var0.field1069) / var2;
      var0.field1059 += (var4 - var0.field1059) / var2;
      var0.field1079 = 0;
      var0.field1043 = var0.field1051;
   }
