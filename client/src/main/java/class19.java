...
public abstract class class19 extends Applet implements Runnable, FocusListener, WindowListener {
   ...
   protected static int field120;
   protected static long[] field105;
   protected static long[] field112;
   static boolean field100;
   static class19 field115;
   static class275 field96;
   static class337 field128;
   static int field102;
   static int field103;
   static int field118;
   static int field126;
   static long field117;
   static long field123;
   static long field127;
   static volatile boolean field125;
   boolean field119;
   boolean field130;
   class10 field122;
   int field108;
   ...
   volatile boolean field107;
   volatile boolean field116;
   volatile long field121;
   ...
   static {
      ...
      field103 = 1;
      field120 = 0;
      field105 = new long[32];
      field112 = new long[32];
      field118 = 500;
      field125 = true;
      field123 = -1L;
      field127 = -1L;
   ...
   final void method159() {
      ...
      if (var2 != null) {
         ...
         class69.field971 = Math.min(this.field104, this.field113);
         client.field687 = Math.min(this.field98, this.field114);
         this.field109 = (this.field104 - class69.field971) / 2;
         this.field110 = 0;
         this.field106.setSize(class69.field971, client.field687);
         class264.field3194 = new class18(class69.field971, client.field687, this.field106);
   ...
   void method161() {
      ...
      int var4 = this.field104 - class69.field971 - var2;
      int var5 = this.field98 - client.field687 - var3;
   ...
   final void method299() {
      Canvas var2 = this.field106;
      var2.removeKeyListener(class11.field59);
      var2.removeFocusListener(class11.field59);
      class11.field51 = -1;
      ...
      var3.addKeyListener(class11.field59);
      var3.addFocusListener(class11.field59);
      class181.method3189(this.field106);
      if (null != this.field122) {
         this.field122.method59(this.field106);
      }
   ...
   protected final void method217(int var1, int var2, int var3) {
      try {
         ...
         field115 = this;
         class69.field971 = var1;
         client.field687 = var2;
   ...
   final synchronized void method274() {
      ...
      class69.field971 = Math.max(var2.getWidth(), this.field111);
      client.field687 = Math.max(var2.getHeight(), this.field108);
      Insets var3;
      if (null != this.field99) {
         var3 = this.field99.getInsets();
         class69.field971 -= var3.right + var3.left;
         client.field687 -= var3.bottom + var3.top;
      }
      ...
      this.field116 = true;
      if (null != class264.field3194 && class264.field3194.field4254 == class69.field971 && class264.field3194.field4253 == client.field687) {
   ...
   protected final void method180(int var1, String var2, boolean var3) {
      try {
         ...
         if (var3) {
            ...
            var5.fillRect(0, 0, class69.field971, client.field687);
         }
         ...
         try {
            ...
            var5.drawImage(class55.field795, class69.field971 / 2 - 152, client.field687 / 2 - 18, (ImageObserver)null);
         } catch (Exception var10) {
   ...
   protected void method182(String var1) {
      if (!this.field130) {
         this.field130 = true;
   ...
   static final void method301(class249 var0, int var1, int var2) {
      if (1 == var0.field2961) {
         class8.method38(var0.field3085, "", 24, 0, 0, var0.field2958);
      }
      ...
      if (2 == var0.field2961 && !client.field563) {
         ...
         if (var4 != null) {
            class8.method38(var4, class44.method770(65280) + var0.field3041, 25, 0, -1, var0.field2958);
         }
      }

      if (var0.field2961 == 3) {
         class8.method38(class270.field3389, "", 26, 0, 0, var0.field2958);
      }

      if (var0.field2961 == 4) {
         class8.method38(var0.field3085, "", 28, 0, 0, var0.field2958);
      }

      if (5 == var0.field2961) {
         class8.method38(var0.field3085, "", 29, 0, 0, var0.field2958);
      }

      if (6 == var0.field2961 && client.field574 == null) {
         class8.method38(var0.field3085, "", 30, 0, -1, var0.field2958);
      }
            ...
            for(var6 = 0; var6 < var0.field2973; ++var6) {
               ...
               if (var1 >= var7 && var2 >= var8 && var1 < var7 + 32 && var2 < 32 + var8) {
                  ...
                  if (var0.field3086[var16] > 0) {
                     class157 var9 = class11.method93(var0.field3086[var16] - 1);
                     if (client.field561 == 1 && class227.method3899(class241.method4140(var0))) {
                        if (class62.field912 != var0.field2958 || class11.field41 != var16) {
                           class8.method38(class270.field3380, client.field530 + " " + class79.field1143 + " " + class44.method770(16748608) + var9.field1836, 31, var9.field1802, var16, var0.field2958);
                        }
                     } else if (client.field563 && class227.method3899(class241.method4140(var0))) {
                        if ((class208.field2474 & 16) == 16) {
                           class8.method38(client.field566, client.field466 + " " + class79.field1143 + " " + class44.method770(16748608) + var9.field1836, 32, var9.field1802, var16, var0.field2958);
                        }
                     } else {
                        ...
                        if (class227.method3899(class241.method4140(var0))) {
                        ...
                        if (var22) {
                           class8.method38(class270.field3380, class44.method770(16748608) + var9.field1836, 38, var9.field1802, var16, var0.field2958);
                        }
                        ...
                        if (null != var10) {
                           for(var14 = 4; var14 >= 0; --var14) {
                              if (var10[var14] != null) {
                                 ...
                                 class8.method38(var10[var14], class44.method770(16748608) + var9.field1836, var15, var9.field1802, var16, var0.field2958);
                              }
                           }
                        }

                        class8.method38(class270.field3381, class44.method770(16748608) + var9.field1836, 1005, var9.field1802, var16, var0.field2958);
                     }
                  }
               }
      ...
      if (var0.field2993) {
         if (client.field563) {
            if (class111.method2112(class241.method4140(var0)) && 32 == (class208.field2474 & 32)) {
               class8.method38(client.field566, client.field466 + " " + class79.field1143 + " " + var0.field3037, 58, 0, var0.field3031, var0.field2958);
            }
         } else {
            for(var16 = 9; var16 >= 5; --var16) {
               ...
               if (var17 != null) {
                  class8.method38(var17, var0.field3037, 1007, 1 + var16, var0.field3031, var0.field2958);
               }
            }

            var4 = class25.method413(var0);
            if (null != var4) {
               class8.method38(var4, var0.field3037, 25, 0, var0.field3031, var0.field2958);
            }
            ...
            for(var5 = 4; var5 >= 0; --var5) {
               ...
               if (var19 != null) {
                  class25.method400(var19, var0.field3037, 57, var5 + 1, var0.field3031, var0.field2958, var0.field3104);
               }
            }
            ...
            if (var20) {
               class8.method38(class270.field3232, "", 30, 0, var0.field3031, var0.field2958);
            }
         }
      }
