public class class251 {
   ...
   public static class290 method4287(class290[] var0, int var1) {
      class290[] var3 = var0;
   ...
   public static boolean method4294(int var0) {
      if (class101.field1282[var0]) {
         return true;
      } else if (!class249.field2951.method4416(var0)) {
         return false;
      } else {
         int var2 = class249.field2951.method4438(var0);
         if (var2 == 0) {
            class101.field1282[var0] = true;
            return true;
         } else {
            if (class249.field3039[var0] == null) {
               class249.field3039[var0] = new class249[var2];
            }

            for(int var3 = 0; var3 < var2; ++var3) {
               if (null == class249.field3039[var0][var3]) {
                  byte[] var4 = class249.field2951.method4412(var0, var3);
                  if (var4 != null) {
                     class249.field3039[var0][var3] = new class249();
                     class249.field3039[var0][var3].field2958 = var3 + (var0 << 16);
                     if (var4[0] == -1) {
                        class249.field3039[var0][var3].method4219(new class385(var4));
                     } else {
                        class249.field3039[var0][var3].method4218(new class385(var4));
                     }
                  }
               }
            }
