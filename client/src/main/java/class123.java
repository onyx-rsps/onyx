public class class123 extends class104 {
      ...
      if (3200 == var0) {
         ...
         if (3209 != var0 && 3181 != var0 && 3203 != var0 && 3205 != var0 && var0 != 3207) {
            if (var0 != 3210 && var0 != 3182 && var0 != 3204 && 3206 != var0 && var0 != 3208) {
               ...
               if (6 == var4) {
                  float var6 = 200.0F * ((float)class38.field308.field1118 - 0.5F);
                  var5 = 100 - Math.round(var6);
               } else if (var4 == 7) {
                  var5 = Math.round((float)class38.field308.field1119 / 2.55F);
               } else if (8 == var4) {
                  var5 = Math.round((float)class38.field308.field1121 / 1.27F);
               } else if (9 == var4) {
                  var5 = Math.round((float)class38.field308.field1116 / 1.27F);
               }
   ...
   static class249 method2215(class249 var0) {
