   ...
   static final void method2253(class385 var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      if (var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) {
         ...
         while(true) {
            ...
            if (var8 <= 49) {
               class61.field895[var1][var2][var3] = var0.method5949();
               ...
               if (5004 == var0) {
                  ...
                  if (5008 == var0) {
                     ...
                     if (var0 == 5016) {
                        ...
                        var8 = class51.field747[--class51.field746];
                        class51.field747[++class51.field746 - 1] = class243.method4150(var8);
                        return 1;
                     } else if (5020 == var0) {
                        var4 = class51.field738[--class2.field4];
                     ...
                     if (class20.field140 != null && class20.field140.field980 != null) {
                        var4 = class20.field140.field980.method6521();
                     } else {
                        var4 = "";
                     }
