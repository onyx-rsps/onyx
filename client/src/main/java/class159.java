public class class159 extends class349 {
   ...
   static class223 field1858;
   static class223 field1861;
   int[] field1870;
   int[] field1874;
   ...
   static {
      field1861 = new class223(64);
      field1858 = new class223(100);
   }
   ...
   void method2775(class385 var1, int var2) {
      ...
      if (1 == var2) {
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            this.field1870[var5] = var1.method5948();
         }
         ...
         this.field1868 = var1.method5948();
      } else if (var2 == 10) {
         this.field1860 = var1.method5948();
      } else if (11 == var2) {
         this.field1876 = var1.method5948();
      } else if (12 == var2) {
         var4 = var1.method5948();
   ...
   static final void method2805() {
      class20.method326(class270.field3272);
   }
