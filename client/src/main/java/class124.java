...
public class class124 extends class354 {
   ...
   public static int method2218(int var0, int var1, int var2, class161 var3, class160 var4, boolean var5, int[] var6, int[] var7) {
      ...
      if (1 == var2) {
         ...
         var28 = class11.method95(var0, var1, var3, var4);
      } else {
         var11 = var0;
         var12 = var1;
         byte var13 = 64;
   ...
   public int method2222(String var1) {
      if (!this.field1435) {
         ...
         for(int var3 = 0; var3 < this.field1436.size(); ++var3) {
            if (((class106)this.field1436.get(var3)).field1303.method6521().equalsIgnoreCase(var1)) {
               return var3;
            }
         }
   ...
   void method2224(class385 var1) {
      ...
      if (var5 > 0) {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            if (this.field1435) {
               var7.field1303 = new class406(var1.method5957());
            }
   ...
   static final void method2242(boolean var0) {
      for(int var2 = 0; var2 < client.field685; ++var2) {
         ...
         if (null != var3 && var3.method1748() && var3.field1132.field1641 == var0 && var3.field1132.method2472()) {
            int var4 = var3.field1069 >> 7;
            int var5 = var3.field1059 >> 7;
            if (var4 >= 0 && var4 < 104 && var5 >= 0 && var5 < 104) {
               if (var3.field1024 == 1 && 64 == (var3.field1069 & 127) && 64 == (var3.field1059 & 127)) {
               ...
               class166.field1925.method3508(class285.field3652, var3.field1069, var3.field1059, class123.method2216(var3.field1024 * 64 - 64 + var3.field1069, var3.field1024 * 64 - 64 + var3.field1059, class285.field3652), 60 + (var3.field1024 * 64 - 64), var3, var3.field1022, var6, var3.field1023);
            }
         }
      }
