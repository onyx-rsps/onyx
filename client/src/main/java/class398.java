...
public class class398 {
   static byte[][] field4282;
   static int field4280;
   static int field4281;
   static int field4285;
   static int[] field4283;
   static int[] field4284;

   static String method7118(Throwable var0) throws IOException {
      String var2;
      if (var0 instanceof class408) {
         class408 var3 = (class408)var0;
         var2 = var3.field4314 + " | ";
         var0 = var3.field4318;
      } else {
         var2 = "";
