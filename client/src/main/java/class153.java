public class class153 extends class349 {
   public static class223 field1697;
   ...
   void method2553(Buffer var1, int var2) {
      if (var2 == 1) {
         ...
         this.field1701 = var1.method5957();
      }
   ...
   static void method2564(class159 var0, int var1, int var2, int var3) {
      if (client.field498 < 50 && class38.field308.field1116 != 0) {
   ...
   static void method2565(class70 var0, int var1, int var2) {
      if (var1 == var0.field1053 && var1 != -1) {
      ...
      } else if (-1 == var1 || var0.field1053 == -1 || class48.method1312(var1).field1864 >= class48.method1312(var0.field1053).field1864) {
         var0.field1053 = var1;
         var0.field1054 = 0;
         var0.field1055 = 0;
         var0.field1056 = var2;
         var0.field1057 = 0;
         var0.field1067 = var0.field1027;
      }
      ...
      if (var4 > client.field685) {
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            ...
            if (var8 == 0) {
               ...
               if (var9 == 0) {
                  ...
                  client.field450[++client.field685 - 1] = var6;
                  var7.field1070 = client.field452;
                  var10 = var3.method5893(3);
                  var7.method1832(var10, (byte)1);
                  var11 = var3.method5893(1);
                  if (var11 == 1) {
                     client.field475[++client.field501 - 1] = var6;
                  }
               } else if (2 == var9) {
                  ...
                  var11 = var3.method5893(3);
                  var7.method1832(var11, (byte)2);
                  var12 = var3.method5893(1);
                  if (var12 == 1) {
                     client.field475[++client.field501 - 1] = var6;
                  }
               } else if (3 == var9) {
         ...
         for(var15 = 0; var15 < client.field501; ++var15) {
            ...
            if ((var6 & 128) != 0) {
               ...
               var16.field1065 += var16.field1077[0];
               var16.field1064 += var16.field1076[0];
               var16.field1066 += var16.field1077[0];
            }
            ...
            if (0 != (var6 & 16)) {
               var17 = var1.method5988();
               if (var17 == 65535) {
                  var17 = -1;
               }

               var8 = var1.method5948();
               if (var16.field1053 == var17 && -1 != var17) {
               ...
               } else if (var17 == -1 || -1 == var16.field1053 || class48.method1312(var17).field1864 >= class48.method1312(var16.field1053).field1864) {
                  var16.field1053 = var17;
                  var16.field1054 = 0;
                  var16.field1055 = 0;
                  var16.field1056 = var8;
                  var16.field1057 = 0;
                  var16.field1067 = var16.field1027;
               }
            }

            if ((var6 & 1) != 0) {
               var17 = var1.method5977();
               int var13;
               if (var17 > 0) {
               ...
               if (var8 > 0) {
                  for(var9 = 0; var9 < var8; ++var9) {
                     ...
                     if (var11 != 32767) {
                        var12 = var1.method5962();
                        var13 = var1.method6164();
                        int var14 = var11 > 0 ? var1.method5948() : var13;
            ...
            if (0 != (var6 & 4)) {
               var16.field1034 = var1.method5957();
               var16.field1037 = 100;
            }
