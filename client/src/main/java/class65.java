...
public class class65 extends Node {
   ...
   static {
      field935 = new class364(32);
   }

   class65() {
      this.field931 = new int[]{-1};
      this.field932 = new int[]{0};
   }
   ...
   static int method1668(int var0, class59 var1, boolean var2) {
      ...
      if (var0 != 1200 && 1205 != var0 && var0 != 1212) {
         if (var0 == 1201) {
            ...
            var4.field2950 = 3;
            var4.field3002 = class20.field140.field979.method4198();
            return 1;
         } else {
            return 2;
         }
         ...
         var4.field3088 = var5;
         var4.field3089 = var6;
         class157 var7 = class11.method93(var5);
   ...
   static final void method1676() {
      for(class57 var1 = (class57)client.field538.method4687(); var1 != null; var1 = (class57)client.field538.method4678()) {
         if (class285.field3652 == var1.field837 && client.field452 <= var1.field844) {
            if (client.field452 >= var1.field839) {
               if (var1.field856 > 0) {
                  class78 var2 = client.field567[var1.field856 - 1];
                  if (var2 != null && var2.field1069 >= 0 && var2.field1069 < 13312 && var2.field1059 >= 0 && var2.field1059 < 13312) {
                     var1.method1582(var2.field1069, var2.field1059, class123.method2216(var2.field1069, var2.field1059, var1.field837) - var1.field846, client.field452);
                  }
               }
               ...
               if (var1.field856 < 0) {
                  ...
                  class70 var4;
                  if (var3 == client.field665) {
                     var4 = class20.field140;
                  } else {
                     var4 = client.field524[var3];
                  }

                  if (null != var4 && var4.field1069 >= 0 && var4.field1069 < 13312 && var4.field1059 >= 0 && var4.field1059 < 13312) {
                     var1.method1582(var4.field1069, var4.field1059, class123.method2216(var4.field1069, var4.field1059, var1.field837) - var1.field846, client.field452);
                  }
               }

               var1.method1583(client.field556);
               class166.field1925.method3508(class285.field3652, (int)var1.field832, (int)var1.field845, (int)var1.field833, 60, var1, var1.field852, -1L, false);
            }
         } else {
            var1.method5437();
         }
   ...
   static final void method1677(class249 var0, int var1, int var2) {
      if (client.field581 == null && !client.field544) {
         if (null != var0) {
            class249 var5 = class123.method2215(var0);
            if (null == var5) {
               var5 = var0.field3064;
            }
