...
public class class359 {
   ...
   long field4072;
   final int[] field4021;
   public boolean field4026;

   static class231[] method5692() {
      return new class231[]{class231.field2793, class231.field2791, class231.field2790, class231.field2794, class231.field2792, class231.field2797};
   }
   ...
   public class359() {
      ...
      this.field4065 = new HashSet();
      this.field4048 = new HashSet();
      this.field4023 = new HashSet();
      this.field4068 = false;
      this.field4069 = 0;
      this.field4021 = new int[]{1008, 1009, 1010, 1011, 1012};
      this.field4073 = new HashSet();
      this.field4074 = null;
      this.field4026 = false;
      this.field4078 = -1;
      this.field4028 = -1;
      this.field4080 = -1;
   }
   ...
   public void method5544(class277 var1, class277 var2, class277 var3, class302 var4, HashMap var5, class397[] var6) {
      ...
      int var8 = this.field4044.method4428(class187.field2118.field2114);
   ...
   void method5486(int var1, int var2, boolean var3, long var4) {
      if (this.field4067 != null) {
         ...
         if (null != this.field4074 && var3) {
            if (class143.method2427() && class11.field46[82] && class11.field46[81]) {
               ...
               if (var8) {
                  class229 var11 = class149.method2495(class227.field2667, client.field453.field1205);
                  var11.field2691.method5992(this.field4074.method4161());
