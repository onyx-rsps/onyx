public class class158 extends class349 {
   public static class223 field1843;
   ...
   public void method2758(class385 var1, int var2) {
      while(true) {
   ...
   void method2759(class385 var1, int var2, int var3) {
      if (var2 == 1) {
         this.field1844 = var1.method5952();
      } else if (var2 == 2) {
         this.field1856 = var1.method5948();
      } else if (var2 == 5) {
