public final class class194 {
   ...
   static final void method3400() {
      for(int var1 = 0; var1 < client.field498; ++var1) {
         ...
         if (client.field652[var1] >= -10) {
            ...
            if (var11 == null) {
               ...
               var11 = class22.method357(class139.field1521, client.field629[var1], 0);
               if (null == var11) {
                  continue;
               }
            ...
            if (client.field652[var1] < 0) {
               ...
               if (0 != client.field653[var1]) {
                  ...
                  int var6 = 64 + 128 * var5 - class20.field140.field1069;
                  if (var6 < 0) {
                     var6 = -var6;
                  }

                  int var7 = client.field653[var1] >> 8 & 255;
                  int var8 = 128 * var7 + 64 - class20.field140.field1059;
                  if (var8 < 0) {
                     var8 = -var8;
                  }
                  ...
                  var3 = (var4 - var9) * class38.field308.field1116 / var4;
               } else {
                  var3 = class38.field308.field1121;
               }
      ...
      if (client.field648) {
         ...
         if (!var10) {
            if (class38.field308.field1119 != 0 && -1 != client.field640) {
               class83.method1886(class109.field1326, client.field640, 0, class38.field308.field1119, false);
            }
