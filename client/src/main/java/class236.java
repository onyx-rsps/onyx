public class class236 extends class31 {
   ...
   public class236() {
      this.field2827 = 256;
      this.field2825 = 1000000;
      this.field2852 = new int[16];
      this.field2826 = new int[16];
      ...
      this.field2843 = new class241[16][128];
      this.field2844 = new class241[16][128];
      this.field2845 = new class237();
      this.field2850 = new class239(this);
      this.field2828 = new class364(128);
      this.method3983();
   }
   ...
   void method4015(int var1, int var2, int var3) {
      ...
      class238 var9 = (class238)this.field2828.method5746((long)this.field2830[var1]);
      if (null != var9) {
