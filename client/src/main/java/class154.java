public class class154 extends class349 {
   ...
   void method2571(class385 var1, int var2) {
      if (var2 == 249) {
   ...
   static final void method2590(class249 var0, int var1) {
   ...
   static final void method2586(class249[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      class394.method6279(var2, var3, var4, var5);
      class198.method3415();

      for(int var10 = 0; var10 < var0.length; ++var10) {
         class249 var11 = var0[var10];
            ...
            if (!var11.field2993 || !class151.method2531(var11)) {
               ...
               if (!var11.field2993 || var16 < var18 && var17 < var19) {
                  if (var11.field2962 != 0) {
                     if (var11.field2962 == 1336) {
                        if (client.field422) {
                           ...
                           var22 = 16776960;
                           if (var21 > 327680 && !client.field409) {
                              var22 = 16711680;
                           }
                  ...
                  if (var11.field2977 == 0) {
                     ...
                     method2586(var0, var11.field2958, var16, var17, var18, var19, var13 - var11.field3054, var14 - var11.field2968, var12);
                     if (var11.field3061 != null) {
                        method2586(var11.field3061, var11.field2958, var16, var17, var18, var19, var13 - var11.field3054, var14 - var11.field2968, var12);
                     }

                     class67 var31 = (class67)client.field569.method5746((long)var11.field2958);
                     if (var31 != null) {
                  ...
                  if (client.field613 || client.field509[var12] || client.field624 > 1) {
                              ...
                              for(var22 = 0; var22 < var11.field2969; ++var22) {
                                 ...
                                 if (var11.field3086[var20] <= 0) {
                                    ...
                                    if (var23 + 32 > var2 && var23 < var4 && 32 + var41 > var3 && var41 < var5 || var11 == client.field688 && var20 == client.field516) {
                                       class398 var44;
                                       if (1 == client.field561 && var20 == class11.field41 && var11.field2958 == class62.field912) {
                                       ...
                                       if (null != var44) {
                                          if (var11 == client.field688 && var20 == client.field516) {
                                             var39 = class20.field142 - client.field404;
                                             var26 = class20.field145 - client.field584;
                                             if (var39 < 5 && var39 > -5) {
                                                var39 = 0;
                                             }
                           ...
                           if (4 == var11.field2977) {
                              ...
                              if (null == var32) {
                                 ...
                                 if (var11.field2993 && -1 != var11.field3088) {
                                    class157 var47 = class11.method93(var11.field3088);
                                 ...
                                 if (!var11.field2993) {
                                    var42 = class70.method1714(var42, var11);
                                 }
                              ...
                              if (var11.field2977 == 6) {
                                 ...
                                 if (-1 != var11.field3088) {
                                    var24 = class11.method93(var11.field3088);
                                    if (null != var24) {
                                    ...
                                    if (var11.field3002 == 0) {
                                       ...
                                       var38 = class20.field140.method3687();
                                    }
                                 } else if (var21 == -1) {
                                    var38 = var11.method4226((class159)null, -1, var34, class20.field140.field979);
                                    if (var38 == null && class249.field2956) {
                                       class81.method1869(var11);
                                    }
                                 } else {
                                    class159 var40 = class48.method1312(var21);
                                    var38 = var11.method4226(var40, var11.field3094, var34, class20.field140.field979);
                                    if (var38 == null && class249.field2956) {
                                       class81.method1869(var11);
                                    }
                                 }

                                 class198.method3418(var13 + var11.field2973 / 2, var14 + var11.field2990 / 2);
                                 var41 = var11.field3000 * class198.field2266[var11.field3009] >> 16;
                                 var39 = var11.field3000 * class198.field2273[var11.field3009] >> 16;
                                 if (var38 != null) {
                                    if (!var11.field2993) {
                                    ...
                                    for(var22 = 0; var22 < var11.field2970; ++var22) {
                                       for(var23 = 0; var23 < var11.field2969; ++var23) {
                                          if (var11.field3086[var21] > 0) {
                                             var24 = class11.method93(var11.field3086[var21] - 1);
                                             String var25;
                                 ...
                                 if (8 == var11.field2977 && var11 == class293.field3699 && client.field560 == client.field649) {
                                    ...
                                    String var35;
                                    for(var37 = class70.method1714(var37, var11); var37.length() > 0; var21 += var33.field3738 + 1) {
                                    ...
                                    for(var37 = class70.method1714(var37, var11); var37.length() > 0; var27 += 1 + var33.field3738) {
