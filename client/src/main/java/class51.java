...
public class class51 {
   ...
   static class249 field750;
   static class44[] field749;
   static int field743;
   static int field746;
   static int field748;
   static int[] field747;
   ...
   static ArrayList field755;
   static Calendar field745;
   static final double field757;
   static final String[] field752;

   static {
      field751 = new int[5];
      field744 = new int[5][5000];
      field747 = new int[1000];
      field738 = new String[1000];
      field748 = 0;
      field749 = new class44[50];
      field745 = Calendar.getInstance();
      field752 = new String[]{"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
      field753 = false;
      field741 = false;
      field755 = new ArrayList();
      field743 = 0;
      field757 = Math.log(2.0D);
   }
   ...
   static final void method1468(boolean var0) {
      if (var0) {
         ...
         LinkedHashMap var2 = class38.field308.field1115;
         String var4 = class56.field809;
   ...
   static final void method1525(int var0, int var1, int var2, int var3, boolean var4) {
      ...
      if (client.field671 != var2 || client.field672 != var3) {
         ...
         for(var10 = 0; var10 < var19.length; ++var10) {
            ...
            int var14 = class198.field2266[var11];
            int var16 = var3 - 334;
            if (var16 < 0) {
               var16 = 0;
            } else if (var16 > 100) {
         ...
         class200.method3532(var19, 500, 800, var2 * 334 / var3, 334);
      }
