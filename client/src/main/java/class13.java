...
public final class class13 extends Canvas {
   ...
   static final void method105(int var0, int var1, int var2, int var3, int var4, int var5, int var6, class200 var7, class160 var8) {
   ...
   public static void method108() {
      class249.field2952.method3883();
      class249.field2953.method3883();
      class249.field2954.method3883();
      class249.field2999.method3883();
   }
      ...
      if (3300 == var0) {
         ...
         if (3301 == var0) {
            ...
            if (var0 == 3308) {
               ...
               var5 = class281.field3625 + (class20.field140.field1069 >> 7);
               var6 = class78.field1134 + (class20.field140.field1059 >> 7);
               ...
               if (client.field577 >= 2) {
                  class51.field747[++class51.field746 - 1] = client.field577;
               } else {
   ...
   static final void method99(class228 var0) {
      ...
      if (var0 == class228.field2676) {
         ...
         if (var9 >= 0 && var10 >= 0 && var9 < 104 && var10 < 104 && var33 >= 0 && var7 >= 0 && var33 < 104 && var7 < 104 && 65535 != var6) {
            ...
            var33 = var33 * 128 + 64;
            var7 = 128 * var7 + 64;
            class57 var45 = new class57(var6, class285.field3652, var9, var10, class123.method2216(var9, var10, class285.field3652) - var12, client.field452 + var15, var34 + client.field452, var32, var14, var13, var11);
            var45.method1582(var33, var7, class123.method2216(var33, var7, class285.field3652) - var11, client.field452 + var15);
         ...
         if (class228.field2677 == var0) {
            ...
            if (null != var18) {
               ...
               int[][] var26 = class62.field911[class285.field3652];
               ...
               if (var30 != null) {
                  class65.method1665(class285.field3652, var14, var15, var12, -1, 0, 0, 1 + var17, var6 + 1);
         ...
         if (class228.field2683 == var0) {
            var32 = var2.method5977();
            var33 = class292.field3695 + (var32 >> 4 & 7);
            var34 = class58.field859 + (var32 & 7);
            var6 = var2.method5979();
            var7 = var2.method5988();
            var8 = var2.method5988();
            if (var33 >= 0 && var34 >= 0 && var33 < 104 && var34 < 104) {
               var33 = 64 + 128 * var33;
               var34 = 64 + 128 * var34;
               class52 var39 = new class52(var8, class285.field3652, var33, var34, class123.method2216(var33, var34, class285.field3652) - var6, var7, client.field452);
               client.field539.method4672(var39);
            }

         } else if (class228.field2684 == var0) {
            var32 = var2.method5988();
            ...
            if (class228.field2681 == var0) {
               ...
               if (var33 >= 0 && var34 >= 0 && var33 < 104 && var34 < 104) {
                  ...
                  if (null != var35) {
                     ...
                     if (var35.method4687() == null) {
                        client.field536[class285.field3652][var33][var34] = null;
                     }
               ...
               var34 = class58.field859 + (var32 & 7);
               var6 = var2.method6164();
               var7 = var6 >> 2;
               var8 = var6 & 3;
               var9 = client.field468[var7];
               if (var33 >= 0 && var34 >= 0 && var33 < 104 && var34 < 104) {
                  class65.method1665(class285.field3652, var33, var34, var9, -1, var7, var8, 0, -1);
               }
               ...
               if (class228.field2682 == var0) {
                  ...
                  var8 = var7 >> 4 & 15;
                  var9 = var7 & 7;
                  var10 = var2.method6164();
                  if (var34 >= 0 && var6 >= 0 && var34 < 104 && var6 < 104) {
                     var11 = var8 + 1;
                     if (class20.field140.field1076[0] >= var34 - var11 && class20.field140.field1076[0] <= var34 + var11 && class20.field140.field1077[0] >= var6 - var11 && class20.field140.field1077[0] <= var6 + var11 && class38.field308.field1116 != 0 && var9 > 0 && client.field498 < 50) {
               ...
               if (class228.field2675 == var0) {
                  ...
                  if (var33 >= 0 && var34 >= 0 && var33 < 104 && var34 < 104) {
                     ...
                     if (client.field536[class285.field3652][var33][var34] == null) {
                        client.field536[class285.field3652][var33][var34] = new class296();
                     }

                     client.field536[class285.field3652][var33][var34].method4672(var37);
                     class49.method1382(var33, var34);
                  }
                  ...
                  var33 = class292.field3695 + (var32 >> 4 & 7);
                  var34 = class58.field859 + (var32 & 7);
                  var6 = var2.method5988();
                  var7 = var2.method5979();
                  var8 = var7 >> 2;
                  var9 = var7 & 3;
                  var10 = client.field468[var8];
                  if (var33 >= 0 && var34 >= 0 && var33 < 103 && var34 < 103) {
                     if (var10 == 0) {
                        class212 var41 = class166.field1925.method3583(class285.field3652, var33, var34);
                        if (var41 != null) {
                           var12 = class79.method1843(var41.field2516);
                           if (2 == var8) {
                              var41.field2514 = new class60(var12, 2, 4 + var9, class285.field3652, var33, var34, var6, false, var41.field2514);
                              var41.field2515 = new class60(var12, 2, 1 + var9 & 3, class285.field3652, var33, var34, var6, false, var41.field2515);
                           } else {
                              var41.field2514 = new class60(var12, var8, var9, class285.field3652, var33, var34, var6, false, var41.field2514);
                           }
                        }
                     }

                     if (1 == var10) {
                        class214 var42 = class166.field1925.method3520(class285.field3652, var33, var34);
                        if (null != var42) {
                           var12 = class79.method1843(var42.field2523);
                           if (4 != var8 && var8 != 5) {
                              if (var8 == 6) {
                                 var42.field2528 = new class60(var12, 4, 4 + var9, class285.field3652, var33, var34, var6, false, var42.field2528);
                              } else if (var8 == 7) {
                                 var42.field2528 = new class60(var12, 4, 4 + (2 + var9 & 3), class285.field3652, var33, var34, var6, false, var42.field2528);
                              } else if (var8 == 8) {
                                 var42.field2528 = new class60(var12, 4, var9 + 4, class285.field3652, var33, var34, var6, false, var42.field2528);
                                 var42.field2529 = new class60(var12, 4, 4 + (2 + var9 & 3), class285.field3652, var33, var34, var6, false, var42.field2529);
                              }
                           } else {
                              var42.field2528 = new class60(var12, 4, var9, class285.field3652, var33, var34, var6, false, var42.field2528);
                           }
                        }
                     }

                     if (var10 == 2) {
                        class215 var43 = class166.field1925.method3566(class285.field3652, var33, var34);
                        if (var8 == 11) {
                           var8 = 10;
                        }

                        if (var43 != null) {
                           var43.field2536 = new class60(class79.method1843(var43.field2538), var8, var9, class285.field3652, var33, var34, var6, false, var43.field2536);
                        }
                     }

                     if (var10 == 3) {
                        class194 var44 = class166.field1925.method3522(class285.field3652, var33, var34);
                        if (var44 != null) {
                           var44.field2195 = new class60(class79.method1843(var44.field2194), 22, var9, class285.field3652, var33, var34, var6, false, var44.field2195);
                        }
                     }
                  }
